      ...
      path: "/", element: <LayOut></LayOut>, children: [
        ...
        { path: "/skills", element: <Skills></Skills> },
        {
          path: "/projects", element: <Projects></Projects>, children: [
            { index: true, element: <AllProjects></AllProjects> },
            { path: "Html-css", element: <HtmlProjects></HtmlProjects> },
            { path: "js", element: <JsProjects></JsProjects> },
            { path: "react js", element: <ReactProjects></ReactProjects> },
          ]
        },
